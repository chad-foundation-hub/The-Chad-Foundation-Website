          ...
          <div className="otherWays-box">
            ...
            <div className="otherWays-box-right-side">
              ...
              <p className="otherWays-p">
                ...
                and Artists to safeguard hearts by providing 10,000
                Echocardiogram and EKG screenings in 5 states, and Austria, and
                Sweden. It shares heartfelt stories of other Families who have
                lost children to SCD and presents the history and importance of
                heart screenings—its pros and cons— through scientific studies,
                as well as the lifesaving tools—AEDs and CPR. The book has the
                endorsement of Adam Silver, Commissioner of the National
                Basketball Association. From Sudden Cardiac Victims to Survivors
                — heartbreak to heroism — learn how The Chad Foundation and
                countless advocate organizations, cardiologists, and health
                professionals worldwide have safeguarded the lives of youth
                through early preventive screening so they will have a better
                future. 100% of the royalties from the CHAD Book go directly to
                The Chad Foundation for Athletes and Artists, a nonprofit,
                charitable organization, with a 501 c 3 tax-exempt status to
                benefit the youth it serves. “The Gift of Heart and Art”
              </p>
              <button
          ...
          <div className="otherWays-box">
            ...
            <div className="otherWays-box-right-side">
              ...
              <p className="otherWays-p">
                ...
                car. Please safeguard your life and others by joining the{" "}
                <strong>“Chad Safe Driver Campaign - Life is A Gift.”</strong>{" "}
                Order your{" "}
                <strong> “Life is A Gift” Keychain Shield Pendant,” </strong>a
                heavyweight, curved shield pendant with a pewter-like finish.
                Join the <strong>“Chad Honour Roll of Safe Drivers”</strong> by
                taking the{" "}
                <strong>
                  “Life is a Gift pledge: Save Lives, I will not text/drink and
                  drive.”
                </strong>{" "}
                Join the “Honor Roll of Safe Drivers” from all 50 states, and
                countries world- wide. <strong>Hang it in your car</strong>,
                your keychain, use as a piece of jewelry or give a gift as a
                reminder, <strong>“Life is a Gift!”</strong> The Keychain
                Pendant comes in a navy velveteen embossed drawstring pouch;
                high-quality embossed navy gift box is $5 additional.
              </p>
              <button
                className="otherWays-btn"
