        ...
        <div className="chadMissionSupport-box">
          ...
          <div className="chadMissionSupport-box-right-side">
            ...
            <p className="chadMissionSupport-p">
              ...
              pros and cons— through scientific studies, as well as the
              lifesaving tools—AEDs and CPR. The book has the endorsement of
              Adam Silver, Commissioner of the National Basketball Association.
              From Sudden Cardiac Victims to Survivors — heartbreak to heroism —
              learn how The Chad Foundation and countless advocate
              organizations, cardiologists, and health professionals worldwide
              have safeguarded the lives of youth through early preventive
              screening so they will have a better future. 100% of the royalties
              from the CHAD Book go directly to The Chad Foundation for Athletes
              and Artists, a nonprofit, charitable organization, with a 501 c 3
              tax-exempt status to benefit the youth it serves. “The Gift of
              Heart and Art”
            </p>
            <button
        ...
        <div className="chadMissionSupport-box">
          ...
          <div className="chadMissionSupport-box-right-side">
            ...
            <p className="chadMissionSupport-p">
              ...
              the <strong>“Chad Honour Roll of Safe Drivers”</strong> by taking
              the{" "}
              <strong>
              ...
              countries world- wide. <strong>Hang it in your car</strong>, your
              keychain, use as a piece of jewelry or give a gift as a reminder,{" "}
              <strong>“Life is a Gift!”</strong> The Keychain Pendant comes in a
              navy velveteen embossed drawstring pouch; high-quality embossed
              navy gift box is $5 additional.
            </p>
            <button
              className="chadMissionSupport-btn"
